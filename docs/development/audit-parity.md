...
| --- | --- | --- |
| All 35 rules: POL-001..015, APPROLE-001..008, JWT-001/002/003/005/006, K8S-001..006, REF-001 | Equivalent findings on shared fixtures, negative cases and Vault-confirmed disputed semantics | Partial: 19 auth detectors compared against Python on 128 fixtures (284 findings); 9 policy detectors verified on 186 fixtures (102 findings) and HCL privilege signals connected; 5 relationship detectors compared against Python on 32 fixtures (72 findings); POL-013 and complete REF-001 assignment semantics pending |
